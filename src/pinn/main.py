...
def train(domain: Domain):
    ...
    # PDE Parameters go here
    SIG = 0.02
    R = 0.02  # Diffusion coefficient
    STRIKE = 0.5
...
def main():
    ...
    pinn = train(domain)
    save_pinn(args.saveto, pinn, pinn.metadata, domain.to_dict())
    pinn = pinn.to("cpu")
